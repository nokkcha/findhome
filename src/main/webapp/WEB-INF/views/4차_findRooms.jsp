...
<!-- 		                <input type="checkbox" name="room_type" value="gd"> gd -->
<!-- 		                <input type="checkbox" name="room_type" value="gd2"> gd2 -->
		              </div>
		              
	                      층 수 옵션
	                      <div class="form-group">
	                       <input type="button" class="btn te btn-primary ftag ftypeAll" name="living_floor"  value="전체">
		                	<input type="button" class="btn te btn-default floor"  name="living_floor" value="지상층">
		             		<input type="button" class="btn te btn-default ftypeOther"  name="living_floor" value="반지하,옥탑">
		              </div>
	                  </div>
		              </div>
		        ...
		        <div class="range-slider">
					<div class="Container" >
						...
						<div class="form-group">
							...
							onclick="location.href='<c:url value="findRooms-search"/>'">
    ...
    $(document).ready(function(){
    	...
    	// 검색 조건 - 층 수 옵션 [전체] 클릭
        	...
        	$('#search-ok').click(function () {
				alert($('#filter-search').val());

		             $(".rtag").each(function (i) {
		 		         alert($(".rtag").eq(i).attr("value") );
		             });
