...
public class OneRoomBean {
	...
	private Map<String, String> include_fees; // "fees": [ {"name": "전기세"}, (...), {"name": "TV"}, ]
	...
	private Map<String, String> option; // COMMENT """option"": [ {""name"": ""에어컨""}, {""name"": ""냉장고""}, {""name"":
	...
	public Map<String, String> getInclude_fees() {
		return include_fees;
	}
	public void setInclude_fees(Map<String, String> include_fees) {
